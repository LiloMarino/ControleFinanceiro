            ...
            <div id="page-inner">
                ...
                <form action="alterar_conta.php" method="post">
                    <div id="divNome" class="form-group">
                        ...
                        <input id="nome" onblur="isCampoPreenchido(nome,divNome,false)" class="form-control" name="nome" value="<?= $conta->banco_conta ?>" placeholder="Digite o nome do banco. Exemplo: NuBank">
                    </div>
                    <div id="divAgencia" class="form-group">
                        <label for="agencia">Agência</label><span class="red-text">*</span>
                        <input id="agencia" onblur="isCampoPreenchido(agencia,divAgencia,false)" class="form-control" name="agencia" value="<?= $conta->agencia_conta ?>" placeholder="Digite a agência.">
                    </div>
                    <div id="divNconta" class="form-group">
                        <label for="nconta">Número da Conta</label><span class="red-text">*</span>
                        <input id="nconta" onblur="isCampoPreenchido(nconta,divNconta,false)" class="form-control" name="nconta" value="<?= $conta->numero_conta ?>" placeholder="Digite o número da conta.">
                    </div>
                    <div id="divSaldo" class="form-group">
                        <label for="saldo">Saldo</label><span class="red-text">*</span>
                        <input id="saldo" onblur="isCampoPreenchido(saldo,divSaldo,false)" class="form-control" name="saldo" value="<?= $conta->saldo_conta ?>" placeholder="Digite o saldo da conta.">
                    </div>
