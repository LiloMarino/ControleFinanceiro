            ...
            <div id="page-inner">
                ...
                <form action="nova_conta.php" method="post">
                    <div id="divNome" class="form-group">
                        ...
                        <input id="nome" onblur="isCampoPreenchido(nome,divNome,false)" class="form-control" name="nome" placeholder="Digite o nome do banco. Exemplo: NuBank" maxlength="50" required>
                    </div>
                    <div id="divAgencia" class="form-group">
                        <label for="agencia">Agência</label><span class="red-text">*</span>
                        <input id="agencia" onblur="isCampoPreenchido(agencia,divAgencia,false)" class="form-control" name="agencia" placeholder="Digite a agência." maxlength="8" required>
                    </div>
                    <div id="divNconta" class="form-group">
                        <label for="nconta">Número da Conta</label><span class="red-text">*</span>
                        <input id="nconta" onblur="isCampoPreenchido(nconta,divNconta,false)" class="form-control" name="nconta" placeholder="Digite o número da conta." maxlength="12" required>
                    </div>
                    <div id="divSaldo" class="form-group">
                        <label for="saldo">Saldo</label><span class="red-text">*</span>
                        <input id="saldo" onblur="isCampoPreenchido(saldo,divSaldo,false)" class="form-control" name="saldo" placeholder="Digite o saldo da conta." required>
                    </div>
