            ...
            <div id="page-inner">
                ...
                <form action="nova_empresa.php" method="post">
                    <div class="form-group" id="divEmpresa">
                        ...
                        name="nome" placeholder="Digite o nome da empresa. Exemplo: Burger King" maxlength="50" required>
                    </div>
                    ...
                    <button onclick="return ValidarCampos('empresa')" type="submit" name="btn" 
