            ...
            <div id="page-inner">
                ...
                <form action="nova_empresa.php" method="post">
                    <div class="form-group" id="divEmpresa">
                        ...
                        <input id="empresa" onblur="isCampoPreenchido(empresa,divEmpresa,false)" class="form-control" name="nome" placeholder="Digite o nome da empresa. Exemplo: Burger King" maxlength="50" required>
                    </div>
                    <div class="form-group">
                        <label>Telefone</label>
                        <input class="form-control" name="telefone" placeholder="Digite o telefone da empresa. (Opcional)" maxlength="15">
                    </div>
                    <div class="form-group">
